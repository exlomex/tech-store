...
export const ProductTypeFiltersMap: Partial<productTypeFiltersMapInterface> = {
    phones: [
        ...
        },
        {
            ...
            options: ['4 дюймов', '6 дюймов', '7 дюймов'],
            optionKeys: [4, 6, 7]
        },
        {
    ...
    laptops: [
        ...
        },
        {
            ...
            options: ['13 дюймов', '15 дюймов', '17 дюймов', '19 дюймов'],
        ...
        },
        {
            label: 'Бренд',
            labelKey: 'brand',
            options: ['Apple', 'Samsung', 'Sony', 'Lenovo'],
    ...
    tvs: [
        ...
        },
        {
            label: 'Диагональ экрана',
            labelKey: 'screenDiagonal',
            options: ["27 дюймов", "32 дюйма","64 дюйма", "42 дюймов", "46 дюймов", "50 дюймов", "52 дюйма", "55 дюймов"],
            optionKeys: [27, 32, 64, 42, 46, 50, 52, 55]
        },
        {
            label: 'Частота обновления',
            labelKey: 'hz',
            options: ['60 Гц', '144 Гц'],
    ...
    tablets: [
        ...
        },
        {
            label: 'Диагональ экрана',
            labelKey: 'diagonalScreen',
            options: ['8 дюймов', '9 дюймов', '10 дюймов'],
            optionKeys: [8, 9, 10]
        },
        {
            label: 'Оперативная память',
    ...
    music_speakers: [
        {
            ...
            options: ['Аудиосистема', 'Умная колонка'],
            optionKeys: ['AUDIO_SYSTEM', 'SMART_SPEAKER']
        },
        {
            label: 'Формат',
            labelKey: 'format',
            options: ['1.0', '1.1', '2.0', '2.1', '5.1'],
            optionKeys: ['F_1_0', 'F_1_1', 'F_2_0', 'F_2_1', 'F_5_1']
        },
        {
            label: 'Тип питания',
            labelKey: 'energyType',
            options: ['Батарея', 'Сеть'],
        ...
        },
        {
            label: 'Мощность',
            labelKey: 'power',
            options: ['100 Вт', '200 Вт', '300 Вт', '400 Вт', '500 Вт', '600 Вт', '700 Вт', '800 Вт', '900 Вт', '1000 Вт'],
